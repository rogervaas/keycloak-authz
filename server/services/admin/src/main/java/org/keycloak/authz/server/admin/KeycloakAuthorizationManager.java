 ...
 */
package org.keycloak.authz.server.admin;
...
public class KeycloakAuthorizationManager implements Authorization {
    ...
    public KeycloakAuthorizationManager(PersistenceProvider persistenceProvider, List<PolicyProviderFactory> policyProviders) {
