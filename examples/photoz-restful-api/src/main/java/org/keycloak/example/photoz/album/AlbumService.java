...
public class AlbumService {
    ...
    public static final String SCOPE_ALBUM_VIEW = "http://photoz.com/dev/scopes/album/view";
    public static final String SCOPE_ALBUM_CREATE = "http://photoz.com/dev/scopes/album/create";
    public static final String SCOPE_ALBUM_DELETE = "http://photoz.com/dev/scopes/album/delete";
    ...
    private void createProtectedResource(Album album) {
        try {
            ...
            scopes.add(new UmaScopeRepresentation(SCOPE_ALBUM_VIEW));
            scopes.add(new UmaScopeRepresentation(SCOPE_ALBUM_CREATE));
            scopes.add(new UmaScopeRepresentation(SCOPE_ALBUM_DELETE));

            UmaResourceRepresentation albumResource = new UmaResourceRepresentation(album.getName(), scopes, "/album/" + album.getId(), "http://photoz.com/dev/resource/album");
    ...
    private String deleteProtectedResource(Album album) {
        ...
        try {
            ...
            if (!search.isEmpty()) {
                String resourceId = search.iterator().next();
                protection.resource().delete(resourceId);
            }
